module.exports = function (grunt) {
  ...
  grunt.registerMultiTask('index', 'Process index.html template', function index() {
    var
      ...
      jsFiles = filterForJS(this.filesSrc).map(function forEachJSFile(file) {
        return file.replace(dirRE, '');
      }),
      cssFiles = filterForCSS(this.filesSrc).map(function forEachCSSFile(file) {
        return file.replace(dirRE, '');
      });
  ...
  grunt.registerMultiTask('karmaconfig', 'Process karma config templates', function karmaConfig() {
